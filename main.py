"""This part of my code imports all the external libarys."""
...
class MovieAPI:
    ...
    def get_movie_info(self):
        """Create an API endpoint based on user input and retrieve essential information from the TMDb API."""
...
class UsersWatchlist:
    ...
    def __init__(self):
        """Initialize the UsersWatchlist object by creating an empty list for storing user's movie watchlist."""
    ...
    def add_movies_to_watchlist(self, movie_title, movie_rating, movie_genre, movie_overview):
        """Add movie information to the user's watchlist."""
    ...
    def watchlist(self):
        """Display the user's watchlist and allow for modification."""
    ...
    def remove_movies_from_watchlist(self):
        """Allow the user to remove movies from their watchlist."""
...
def year_movie_filter():
    """Filters movies by their release year, Allows the user to select movies released between 2000 and 2024."""
...
def genre_movie_filter():
    """Filters movies by genre, Allows users to specify their preferred genre."""
...
def search_movie_filter():
    """This function enables users to search for movies by their title."""
    while True:
